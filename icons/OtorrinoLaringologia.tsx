...
export default function OtorrinoLaringologia () {
  return (
    <svg
      ...
      width='193.392px'
      height='193.392px'
      viewBox='0 0 193.392 193.392'
    >
      <g>
        <g>
          <path
            d='M64.382,133.17H33.955c0.286,0.627,0.518,1.211,1.06,1.979c1.23,1.711,3.23,3.842,2.01,8.215
          ...
          />
          <path
            d='M154.773,23.571C143.958,11.487,129.637,0.265,94.262,0.003C80.439-0.11,59.337,3.163,42.927,20.523
