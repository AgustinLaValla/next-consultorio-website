...
export default function Pediatria () {
  return (
    <svg
      ...
      width='31.091px'
      height='31.092px'
      viewBox='0 0 31.091 31.092'
    >
      <g>
        <g>
          <path
            d='M15.547,0C7.128,0,0.277,6.851,0.277,15.27c0,7.268,5.107,13.363,11.921,14.896c-0.787-0.76-1.339-1.758-1.541-2.879
          ...
          <path
            d='M10.825,24.711c0.396-1.23,1.229-2.262,2.312-2.919c0.086-1.406,1.238-2.521,2.65-2.521c1.368,0,2.494,1.044,2.64,2.388
          ...
          />
          <path
            d='M16.485,24.55c-0.187-0.062-0.386-0.097-0.592-0.097c-0.225,0-0.439,0.041-0.639,0.113
          ...
          />
          <path
            d='M15.837,20.059c-0.959,0-1.779,0.59-2.121,1.426c0.665-0.301,1.401-0.472,2.178-0.472c0.722,0,1.41,0.147,2.038,0.408
			C17.574,20.619,16.772,20.059,15.837,20.059z'
          />
          <path
            d='M15.894,21.588c-2.62,0-4.752,2.132-4.752,4.752c0,2.619,2.132,4.752,4.752,4.752c2.619,0,4.751-2.132,4.751-4.752
